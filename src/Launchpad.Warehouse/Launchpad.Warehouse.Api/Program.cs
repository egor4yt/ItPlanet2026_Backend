using Launchpad.Warehouse.Api.Configuration;
using Launchpad.Warehouse.Api.Services;
using Launchpad.Warehouse.Application.Configuration;
using Launchpad.Warehouse.Infrastructure.Configuration;
using Launchpad.Warehouse.Infrastructure.Persistence.Configuration;
using Launchpad.Warehouse.Shared;
...
try
{
    ...
    if (string.IsNullOrWhiteSpace(environment.Value)) environment.Value = Launchpad.Warehouse.Shared.Environments.Production;
